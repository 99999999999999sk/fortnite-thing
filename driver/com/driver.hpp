...
// ====================== EXACTEMENT LES MÊMES QUE DANS TON KERNEL ======================
...
namespace mem {
    ...
    bool find_driver() {
        // Nom exact du symbolic link créé dans ton DriverEntry
        ...
        if (driver_handle == INVALID_HANDLE_VALUE) {
            // Essaie avec Global\ si tu es en session 0 ou avec admin élevé
            driver_handle = CreateFileW(
